...
[![npm version](https://badge.fury.io/js/n8n-nodes-cloudflare-r2.svg)](https://www.npmjs.com/package/n8n-nodes-cloudflare-r2)
...
2. Enter `n8n-nodes-cloudflare-r2` in the **Package** field  
3. Click **Install**
